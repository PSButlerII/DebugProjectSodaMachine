...
def simulation_main_menu():
    ...
    while validate_user_selection[0] is False:
        print(f"\t\t-Simulation menu-")
        print(f"\tPress -1- to begin transaction")
        print(f"\tPress -2- to check wallet for coins")
        print(f"\tPress -3- to check backpack for cans")
        print(f"\tPress -4- to terminate simulation")
